...
//            );
        ...
        final ArrayList<Pair<Double,Double>> tmp = GeometricAlgorithms.pointAscendingSort(pointSet, refIndex);
        // find missing points
        ...
        for (int i = 0; i < pointSet.size(); ++i) {
            if (i != referenceIndex) {
                ...
                if (result.size() > 1) {
                    ...
                    final Double currAngle = GeometricAlgorithms.realPolarAngle(xAxis, newVector);
