...
public class NodeGridPosition {
     ...
     */
    public NodeGridPosition(int xPos, int yPos, boolean withDiagonals) {
        this.x = xPos;
        this.y = yPos;
    ...
    public List<Pair<Pair<Integer, Integer>, Boolean>> getExistingPositions() {
        List<Pair<Pair<Integer, Integer>, Boolean>> res = new ArrayList<Pair<Pair<Integer, Integer>, Boolean>>();
        if (this.north != null) {
            res.add(
     ...
     */
    public Pair<Pair<Integer, Integer>, Boolean> randomFreePosition(Random gen) {
        List<Pair<Pair<Integer, Integer>, Boolean>> res = this.getFreePositions();
