...
public class BinaryNumbersTest {
    ...
    public void fromFloat(
        ...
        Assert.assertEquals(BinaryNumbers.fromFloat(BitString.parse(bits), exponentLength, mantissaLength), expected);
    }
    ...
    public void fromOnesComplement(final String bits, final int expected) {
        Assert.assertEquals(BinaryNumbers.fromOnesComplement(BitString.parse(bits)), expected);
    }
    ...
    public void toFloat(final String number, final int exponentLength, final int mantissaLength, final String expected) {
        Assert.assertEquals(BinaryNumbers.toFloat(number, exponentLength, mantissaLength).toString(), expected);
    }
    ...
    public void toOnesComplement(final int number, final int bitLength, final String expected) {
        Assert.assertEquals(BinaryNumbers.toOnesComplement(number, bitLength).toString(), expected);
    }

    @Test(dataProvider="toOnesErrorData")
    public void toOnesComplementErrors(final int number, final int bitLength) {
        Assert.assertThrows(() -> BinaryNumbers.toOnesComplement(number, bitLength));
    }
    ...
    public void toTwosComplementErrors(final int number, final int bitLength) {
        Assert.assertThrows(() -> BinaryNumbers.toTwosComplement(number, bitLength));
    }
