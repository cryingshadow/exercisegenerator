...
public class UnionFindAlgorithm implements AlgorithmImplementation<UnionFindProblem, UnionFind<Integer>>{
    ...
    private static UnionFindProblem generateUnionFindProblem(final Parameters<Flag> options) {
    ...
    private static UnionFindProblem parseUnionFindProblem(
    ...
    @Override
    public UnionFindProblem parseOrGenerateProblem(final Parameters<Flag> options) throws IOException {
        return new ParserAndGenerator<UnionFindProblem>(
            UnionFindAlgorithm::parseUnionFindProblem,
            UnionFindAlgorithm::generateUnionFindProblem
        ).getResult(options);
    }
    ...
    public void printExercise(
        ...
        writer.write("Betrachten Sie die folgende Union-Find-Datenstruktur:\\\\");
        Main.newLine(writer);
