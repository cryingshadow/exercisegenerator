...
public abstract class DynamicProgramming {
    ...
    public static void lcs(
        ...
        int n = wordA.length();
        int m = wordB.length();
        Integer[][] C = new Integer[n+1][m+1];
        String[][] solutions = new String[n + 2][m + 2];
        C[0][0] = 0;
        solutions[0][0] = "";
        ...
        int row = n;
        int column = m;
        List<String> itemsToChoose = new ArrayList<String>();
...
//            boolean remainderStarted = true;
            ...
            String[][] solutionsTmpEx = new String[n + 2][m + 2];
            for (int rowNr = 0; rowNr < n + 2; rowNr++) {
                solutionsTmpEx[rowNr][0] = solutions[rowNr][0];
            }
